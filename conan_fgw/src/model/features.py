...
allowable_features = {
    ...
    "possible_degree_list": list(range(0, 11)),
    "possible_formal_charge_list": list(range(-5, 7)),
    "possible_numH_list": list(range(0, 9)),
    "possible_number_radical_e_list": list(range(0, 5)),
...
def atom_to_feature_vector(atom):
    ...
    atom_feature = [
        ...
        safe_index(
            allowable_features["possible_hybridization_list"], str(atom.GetHybridization())
        ),
